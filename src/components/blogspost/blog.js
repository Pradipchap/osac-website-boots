      ...
      <div className="allblogs">
        <div class="container single" >
          ...
          <section class="featured-posts" >
            ...
            {load===true?<Toploader/>:<div class="card-columns listfeaturedtag" >
              {postLists.map((element) => {
                return (
                  <div class="card" id={element.id} onClick={() => {
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-7">
                        <div class="card-block">
                          ...
                          <h4 class="card-text">{element.desc.slice(0,70)}</h4>
                          <div class="metafooter">
                            <div class="wrapfooter">
                              ...
                              <span class="author-meta">
                                ...
                                <span class="dot"></span>
                                <span class="post-read">{Math.ceil((element.desc.length*0.0458)/60)} min read</span>
                              </span>
